...
},{}],"../src/javascripts/application.js":[function(require,module,exports) {
"use strict";
...
fetch('https://my-json-server.typicode.com/marcomontalbano/an-introduction-to-frontend/articles').then(function (response) {
  return response.json();
}).then(function (articles) {
  console.log(articles);
  var articlesAsHtml = articles.map(function (article) {
    return _mustache.default.render(source, article);
  });
...
articleContainer.addEventListener('click', function (event) {
  ...
  if (likeButton.matches('.article--like')) {
    event.preventDefault();
    var articleElement = likeButton.closest('.article');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/javascripts/application.js"], null)
//# sourceMappingURL=/application.67df3123.js.map